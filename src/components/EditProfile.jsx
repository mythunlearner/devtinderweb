...
{!age && (
  <p className="validator-hint text-red-500">Required</p>
)}

{age && !/^[0-9]{1,2}$/.test(age) && (
  <p className="validator-hint text-red-500">Enter a valid age (1–99)</p>
)}
...
{gender && !/^(Male|Female|Other)$/i.test(gender) && (
  <p className="validator-hint text-red-500">Allowed: Male, Female, or Other</p>
)}
...
<label className="flex items-start gap-2 p-2 border rounded-lg bg-gray-900 text-white focus-within:ring-2 focus-within:ring-blue-500">
  <svg className="h-5 w-5 opacity-50 mt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor">
